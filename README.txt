...
ChapaGol es un juego de fútbol por turnos. Cada usuario elige qué jugadores mover y qué acciones tomar. En cada turno tienes 5 puntos de acción. 
...
Objetivo: El objetivo es jugar partidos con un amigo en local, como los juegos antiguos de PC en los que dos personas utilizaban el mismo teclado. 
...
Jugadores: Los jugadores tienen estadísticas de resistencia, tiro, pase, regate, defensa y físico. En el caso de los porteros tendrán estadísticas adicionales de estirada, parada, saque, reflejos, velocidad y posicionamiento. El éxito de cualquier acción que haga un jugador dependerá de sus estadísticas, entre otras cosas. Para más detalles, consultar el apartado "Acciones"
...
-	Regatear: Si tienes a un rival a una casilla de distancia, puedes intentar regatearle. La probabilidad de éxito del regate depende de la 
  estadística de regate del atacante y la estadística de defensa del defensor. En caso de conseguirlo, cambiarás tu posición con la del jugador 
  regateado, dejándole detrás. En caso de no conseguirlo también intercambiarás posiciones pero el jugador contrario pasará a controlar el balón y se pasará el turno
...
-	Pasar: Puedes pasar a cualquier jugador de tu equipo sin importar la distancia a la que esté. El éxito del pase depende de la distancia y 
  de la estadística de pase del jugador que pasa el balón. Si fallas el pase, el balón puede salir del campo o puede ser interceptado por un rival 
  ...
  contrario, hay una pequeña probabilidad de que haya fuera de juego, que depende del número de rivales que haya en la línea del compañero que recibe el pase. 
  Si pasas a un compañero que esté adelantado, habrá fuera de juego. En caso de fuera de juego, un jugador aleatorio sacará el balón desde el punto en el que estaba el 
  jugador que recibió el balón, y el jugador que cometió el 
  fuera de juego se recolocará en una casilla aleatoria.

-	Tirar: Puedes tirar a puerta desde cualquier sitio sin importar la distancia a la que estés, pero solamente será posible meter gol si te encuentras en el campo rival. El 
  éxito del tiro dependerá de las estadísticas del rematador, de la distancia a la portería, de la cantidad de jugadores que haya en el área pequeña y de las estadísticas 
  del portero, si está bajo los tres palos en ese momento. Los posibles resultados de un tiro a puerta son:
...
-	Entrada: Si estás a una casilla de distancia del rival puedes hacerle una entrada. El éxito de la entrada depende de las estadísticas del defensor. 
  ...
  o	Roja directa: Si la falta fue hecha a un rival sin balón, el árbitro pitará roja directa. Si el rival tiene el balón, todavía existe la posibilidad de que el defensor 
    reciba una roja directa, en cuyo caso será expulsado
